...
export function GetMapping(path: string, config?: { authenticated?: boolean, activated?: boolean, roles?: string[] }): Function {
	return (target: any, propertyKey: string) => {
		...
		routes.push({ method: 'get', path, methodName: propertyKey, config });
