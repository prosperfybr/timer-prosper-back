...
export function PutMapping(path: string, config?: { authenticated?: boolean, activated?: boolean, roles?: string[] }): Function {
	return (target: any, propertyKey: string) => {
		...
		routes.push({ method: 'put', path, methodName: propertyKey, config });
